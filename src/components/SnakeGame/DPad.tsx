...
const buttonClass =
  'flex h-10 w-10 items-center justify-center rounded-lg border border-zinc-800 bg-zinc-900 text-zinc-400 transition active:scale-90 active:bg-zinc-800 active:text-white sm:h-11 sm:w-11';
